...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#3F2305] text-white py-3 md:py-5 lg:py-3 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-6  relative ">
          <div>         
            ...
            <div className="flex items-center ">
              ...
              <a href="http://www.ijlai.com" className="hover:underline text-sm sm:text-base poppins-regular ">
                www.ijlai.com
              </a>
            </div>
          </div>
        ...
        <div className="flex flex-col  justify-center text-center text-sm sm:text-base poppins-regular ">
          <p>© 2025 IJLAI. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
